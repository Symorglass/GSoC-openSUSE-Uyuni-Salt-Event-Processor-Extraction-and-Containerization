...
[Uyuni-tools](https://github.com/uyuni-project/uyuni-tools) is a tools for managing Uyuni deployments, including container management. This project also integrates the new Salt event processor container into Uyuni-tools for deployment and lifecycle management.
